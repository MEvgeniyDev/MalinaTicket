...
Перед релизом `26.5.9` были выполнены:

- `.\gradlew.bat clean test`
- `.\gradlew.bat clean shadowJar`
- проверка `major version 60` у классов JAR;
- ручная проверка запуска на Paper/Purpur `1.16.5`, `1.17.1`, `1.18.2`, `1.19.4`, `1.20.4`, `1.20.6`, `1.21.1`, `1.21.11`, `26.1.2`;
- ручная проверка `/ticket`, создания тикета, комментариев, закрытия, кликабельных сообщений и резервных копий в `tickets/backups`.
